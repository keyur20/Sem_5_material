...
<body class="container-fluid">
    ...
    <ul class="text-center font-weight-bold text-monospace text-dark">
        <table border="1" class="table table-hover table-dark">
            ...
            ?><br/>
            <?php
            $query = "SELECT * FROM doctor inner join schedule on schedule.d_id=doctor.id   where permission='approved' AND specialist like'm%' OR permission='Added' AND specialist like'm%' ";
