...
<head>
  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <?php
     ...
     $show_number_pending_request_query = "SELECT * FROM doctor $queryPermission order by date='$d_date' asc";
        ...
        <div class="navbar-header">
          ...
          <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="doctor_list.php">Doctors<span class="caret"></span></i></a>
                <ul class="dropdown-menu">
                  <li><a href='doctor_name_display.php'> Doctors Name display</a></li>
                  <li><a href='add_doctor.php'> Add Members/Doctor</a></li>
                </ul>
              </li>
              <li><a href=doc_reg_request.php>Request <?php if($count > 0) {} echo '('.$count.')'?></a></li>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="../pic/Doctor_Time.jpg" alt="img1" width="2500" height="800" title="Admin Home Page">
