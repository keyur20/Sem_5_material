...
<body class="container-fluid">
  ...
  <table border="1" cellPadding="13" align="center" class="table table-hover table-dark">
    ...
    $query = "SELECT * FROM doctor inner join schedule on schedule.d_id=doctor.id  where permission='approved' AND specialist like's%' OR permission='Added' AND specialist like's%' ";
