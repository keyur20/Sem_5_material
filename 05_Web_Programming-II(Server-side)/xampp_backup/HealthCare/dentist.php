...
<body class="container">
    ...
    <ul class="text-center font-weight-bold text-monospace text-dark">
        <table style="border:1; cellPadding:13; align:center;" class="table table-hover table-dark">
            <thead>
                <tr>
            ...
            $query = "SELECT * FROM doctor inner join schedule on schedule.d_id=doctor.id  where permission='approved' AND specialist like 'd%' OR permission='Added' AND specialist like 'd%' ";
