...
$show_number_pending_request_query = "SELECT * FROM doctor $queryPermission ";
...
$show_approve_request_query = "SELECT * FROM doctor WHERE permission='Approved' || permission='Added'";
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item">
      <img src="pic/home_slide.jpg" alt="img2" width="1200" height="700">
    </div>
  </div>
...
<div id="#" class="bg-1">
  <div class="container">
    ...
    <p class="text-center">Our highly specialized experts are deeply experienced in treating rare and complex conditions. You can get an appointment from here. For getting an appointment, you need to log in to this site. If you are not registered already, <strong style="color:#0066FF"><a href="Users/registration.php">Register</a></strong> here, please. You can still get locations about other nearest hospitals from here.</p>
  </div>
</div>
...
<div class="w3-container w3-content w3-padding-64" style="max-width:800px" id="contact">
  ...
  <p class="w3-opacity w3-center"><i>If you want to know anything from us? Please drop a note here!</i></p>
  <div class="w3-row w3-padding-32">
    <div class="w3-col m6 w3-large w3-margin-bottom">
      <i class="fa fa-map-marker" style="width:30px"></i> Mumbai, India<br>
      <i class="fa fa-phone" style="width:30px"></i> Phone: +091......<br>
      <i class="fa fa-envelope" style="width:30px"> </i> Email: keyur.n.patel100@gmail.com<br>
    </div>
    <?php
    if(isset($_POST["submit"])){
      ...
      if(empty($c_gmail)) {
        ...
        $comment_query = "INSERT INTO comment(name,gmail,text) VALUES('$c_name','$c_gmail','$c_text')";
...
<footer class="text-center">
  ...
  <p>Copyright<a href="http://labaidgroup.com/specialized/doctor" data-toggle="tooltip" title="e-Healthcare">@e-Healthcare | By Karan and Keyur</a></p>
</footer>
<script>
